    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(v -> {
            if (selectedState.equals("Select Your State")) {
                Toast.makeText(Select.this, "Please select your state from the list", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Select.this, "Please select your district from the list", Toast.LENGTH_LONG).show();
